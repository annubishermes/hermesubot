...
PLAY_PIC = (
    os.environ.get("PLAY_PIC") or "https://telegra.ph/file/ad1fa3befa8678fbea52d.jpg"
)

QUEUE_PIC = (
    os.environ.get("QUEUE_PIC") or "https://telegra.ph/file/ad1fa3befa8678fbea52d.jpg"
)
...
with bot:
    try:
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@indraudah"):
                buttons = paginate_help(0, dugmeler, "helpme")
                result = builder.photo(
                    file=logoman,
                    link_preview=False,
                    text=f"**✗ Sensi-Userbot Inline Menu ✗**\n\n✣ **Owner** [{user.first_name}](tg://user?id={user.id})\n✣ **Jumlah** `{len(dugmeler)}` Modules",
                    buttons=buttons,
                )
                ...
                result = builder.article(
                    title="✗ Sensi-Userbot ✗",
                    description="Sensi - UserBot | Telethon",
                    url="https://t.me/indraudah",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text=f"**Sensi - UserBot**\n➖➖➖➖➖➖➖➖➖➖\n✣ **UserMode:** [{user.first_name}](tg://user?id={user.id})\n✣ **Assistant:** {tgbotusername}\n➖➖➖➖➖➖➖➖➖➖\n**Support:** @kata2in\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
